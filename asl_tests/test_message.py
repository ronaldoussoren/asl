...
class TestMessage(unittest.TestCase):
    ...
    def test_no_bytes_attributes(self):
        ...
        self.assertRaises(
            TypeError, m.set_query, "aap", b"hello", asl.ASL_QUERY_OP_EQUAL
        )
        self.assertRaises(
            TypeError, m.set_query, b"aap", "hello", asl.ASL_QUERY_OP_EQUAL
        )
    ...
    def test_unicode_attributes(self):
        ...
        self.assertEqual(
            m.asdict(),
            {"aap": "hello", "noot": "world", "key1": "value1", "key2": "value2"},
        )
